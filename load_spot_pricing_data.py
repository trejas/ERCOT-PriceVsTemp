...
# get data file names
path_2013 =r'.\data\spot_pricing\2013'
filenames_2013 = glob.glob(path_2013 + "/*.csv")
path_2014 =r'.\data\spot_pricing\2014'
filenames_2014 = glob.glob(path_2014 + "/*.csv")
path_2015 =r'.\data\spot_pricing\2015'
filenames_2015 = glob.glob(path_2015 + "/*.csv")
path_2016 =r'.\data\spot_pricing\2016'
filenames_2016 = glob.glob(path_2016 + "/*.csv")
path_2017 =r'.\data\spot_pricing\2017'
